                        ...
                        if ("scroll" === k) {
                            ...
                            o.container
                                ? g.isWrapped(o.container) || g.isNode(o.container)
                                    ...
                                    : (o.container = null)
                                : ((C = v.State.scrollAnchor[v.State["scrollProperty" + S]]), (A = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === S ? "Top" : "Left")]]), (F = $(n).offset()[S.toLowerCase()] + V)),
                                (s = { scroll: { rootPropertyValue: !1, startValue: C, currentValue: C, endValue: F, unitType: "", easing: o.easing, scrollData: { container: o.container, direction: S, alternateValue: A } }, element: n }),
                            ...
                            for (var R in h) {
                                ...
                                if (i(n).isSVG || "tween" === I || x.Names.prefixCheck(I)[1] !== !1 || x.Normalizations.registered[I] !== a) {
                                    ...
                                    if (
                                        ...
                                        (M = parseFloat(M) || 0),
                                        (z = parseFloat(z) || 0),
                                        "%" === G && (/^(fontSize|lineHeight)$/.test(R) ? ((z /= 100), (G = "em")) : /^scale/.test(R) ? ((z /= 100), (G = "")) : /(Red|Green|Blue)$/i.test(R) && ((z = (z / 100) * 255), (G = ""))),
                                        /[\/*]/.test(X))
                                    )
                                        G = D;
                                    else if (D !== G && 0 !== M)
                                    ...
                                    return (
                                        ...
                                        $.each(m, function (e, t) {
                                            parseFloat(F.stagger) ? (F.delay = j + parseFloat(F.stagger) * e) : g.isFunction(F.stagger) && (F.delay = j + F.stagger.call(t, e, P)),
                                                F.drag && ((F.duration = parseFloat(E) || (/^(callout|transition)/.test(h) ? 1e3 : y)), (F.duration = Math.max(F.duration * (F.backwards ? 1 - e / P : (e + 1) / P), 0.75 * F.duration, 200))),
